/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8c063757c7c4336c88276f0104e1ab9)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DISCORD_ACTIVITY_AUTH_RATE_LIMIT: RateLimit;
		BASE_URL: string;
		JWT_SECRET: string;
		COOKIE_DOMAIN: string;
		EXTRA_REDIRECT_ORIGINS: string;
		DISCORD_CLIENT_ID: string;
		DISCORD_CLIENT_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		DISCORD_ACTIVITY_RANGLE_REDIRECT_URI: string;
		DISCORD_ACTIVITY_RANGLE_CLIENT_ID: string;
		DISCORD_ACTIVITY_RANGLE_CLIENT_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "JWT_SECRET" | "COOKIE_DOMAIN" | "EXTRA_REDIRECT_ORIGINS" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "DISCORD_ACTIVITY_RANGLE_REDIRECT_URI" | "DISCORD_ACTIVITY_RANGLE_CLIENT_ID" | "DISCORD_ACTIVITY_RANGLE_CLIENT_SECRET">> {}
}
